...
public class Transfer {
    ...
    @JoinColumn(name = "source_account_number", nullable = false, updatable = false)
    @NotNull(message = "Source account is required")
    private BankAccount sourceAccount;

    @ManyToOne(optional = false)
    @JoinColumn(name = "target_account_number", nullable = false, updatable = false)
     ...
     *
     * @param transferTransactionId transactionId number
    ...
    public Transfer(
        ...
        this.transactionId = transferTransactionId;
